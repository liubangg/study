...
public class FileTransJavaDemo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String accessKeyId = "LTAIBM6AyJ5pqiiT";
        String accessKeySecret = "GDidqQrLOo0WHJqkjZtdeiZQ4TJ5KE";
        final String appKey = "UTTX34XKjk1QN1NM";
        String fileLink = "http://audio.t.bluepulse.cn/20190723/4b81ddba5372403eac91b267d7a6e7b583135.mp3";
        ...
        if (result != null) {
            ...
            FileUtil.saveDataToFile("C:\\Users\\刘邦国\\Desktop\\文档\\字幕json\\huati-result.json",result);
        }
        else {
